...
public class quiz {
	...
	public static void main(String[] args) {
		 ...
		 * Test Driven Devolopment - you write a unit test first and then you go back and write the code to pass the tests written.
		 */
		
		/* 42. When would you use an interface?
		 *  I would use and interface when I would expect that my code will need to be changed over time. Interfaces allows code to me more flexible.
		 */
		 ...
		 *  public createStringCount
		 */
	}
		StringBuilder createStringCount = new StringBuilder();
		public static String createStringCount(int num) {
